...
import { IFileSource, File, joinHdfsPath } from '../../fileSources';
import { generateGuid } from '../../services/serviceUtils';

// Stores important state and service methods used by the Spark Job Submission Dialog.
export class SparkJobSubmissionModel {
    public hadoopConnection: connectionProvider.Connection;
    ...
    constructor(
        ...
        requestService?: (args: any) => any) {
            ...
            this.hadoopConnection = new connectionProvider.Connection(this._sqlopsConnection, undefined, this._sqlopsConnection.connectionId);
            this._guidForClusterFolder = generateGuid();
        }
