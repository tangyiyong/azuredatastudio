...
import { IExtensionApi, IObjectExplorerBrowser } from './types';
import { HadoopObjectExplorerProvider } from './dataprotocol/objectExplorerProvider';
...
export function activate(extensionContext: vscode.ExtensionContext): Promise<IExtensionApi> {
